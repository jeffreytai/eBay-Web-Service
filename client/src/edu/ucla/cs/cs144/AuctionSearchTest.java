...
public class AuctionSearchTest {
	...
	throws AxisFault {
		...
		// SearchResult[] basicResults = AuctionSearchClient.basicSearch(query, 0, 68);
		...
		// }
                ...
                SearchResult[] spatialResults = AuctionSearchClient.spatialSearch("kitchen", region, 0, 20);
                System.out.println("Spatial Search");
                System.out.println("size of spatialResults array is: " + spatialResults.length);
